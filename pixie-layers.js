...
// pixie-layers.js
//
// Weatherpixie layer compositing without Node
// 2023-11-30 with plocket:
// We want to produce a layer file object for using
// to parse a pixel description object (pixie params)
// into a list of layer file paths.
...
// subdirectories after root as given below
const pixies = [
        'pixies/pixiemoomin/',
        'pixies/pixiebunny/',
        'pixies/pixie0/',
...
const root = './pixifier';
// sample replacement of path joining with concatenation and template literals.
const pix = `${root}/${pixies[Math.floor(Math.random() * pixies.length)])}`;
